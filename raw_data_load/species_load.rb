...
@connection = Mysql.real_connect("140.254.80.125", "depthmap", "depthmap", "map")

file = File.open("fish.txt")do |infile|
infile.gets
  while (line = infile.gets)
    puts "INSERT INTO depthmap.species VALUES(Name,Epithet,Kingdom,Phylum,Class)" 
